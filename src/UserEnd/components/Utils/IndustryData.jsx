...
export default function IndustryData({values}) {
    return (
        <Paper sx={{ml: 1.2, mr: 1.5}}>
            ...
            <Card>
                ...
                <CardContent sx={{paddingBottom: 0}}>
                    ...
                    >
                        {values.IndustryProfile && values.IndustryProfile.location}
                    </Typography>
                    <Grid item container direction="row" marginTop={0.5} spacing={1}>
                        ...
                        <Grid item md={6}> <Button
                            ...
                            variant="outlined"
                            size="small"
                            LinkComponent={Link} to={"viewIndustry/" + values.id}
                        >
                            View Profile
                        </Button>
                        </Grid>
