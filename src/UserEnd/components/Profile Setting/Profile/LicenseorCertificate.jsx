...
export default function LicenseorCertificate() {
  ...
  return (
    ...
    <Stack direction={'row'} alignItems={'center'}justifyContent='center' spacing={2} sx={{pb:2}}>
      ...
      {!toggleCancel && <Stack direction={'row'} alignItems={'center'}justifyContent='center' spacing={2} sx={{pb:3}}>
