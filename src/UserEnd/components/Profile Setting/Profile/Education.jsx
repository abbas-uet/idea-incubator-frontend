...
export default function Education() {
  ...
  return (
    ...
    <Grid item md={12}>
        <TextField
          ...
          label="School"
          name="school"
          placeholder="Ex: Punjab University"
          variant="outlined"
          size="small"
    ...
    <Stack direction={'row'} alignItems={'center'}justifyContent='center' spacing={2} sx={{pb:2,pt:2}}>
 ...
 <Grid item md={12}>
     <TextField
       ...
       name="activity"
       placeholder="Ex: SAAC Society,Coding Competition"
       variant="outlined"
       size="small"
       multiline
      fullWidth
