...
export default function AdminAssets({ cardObj}) {
    ...
    return (
        <Page title={"Assets | Idea Incubator"}>
            <Container>
                <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                    <BreadCrumb linkArr={['Dashboard','Assets']}/>
                    <Button
                        variant="contained"
                        color={'inherit'}
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell align="right">
                                                    <UserMoreMenu pageName={"Asset"} id={id}/>
                                                </TableCell>
                                            </TableRow>
                                            );
                                        }
            ...
            <AddNew open={open} handleClose={handleClose} pageName={"Assets"}/>
        </Page>
    );
}
