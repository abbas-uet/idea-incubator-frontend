...
export default function AdminTalent({ cardObj}) {
    ...
    return (
        <Page title={"Talent | Idea Incubator"}>
            <Container>
                <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                    <BreadCrumb linkArr={['Dashboard','Talent']}/>
                    <Button
                        variant="contained"
                        color={'inherit'}
                ...
                <Grid container spacing={2} justifyContent="space-between" mb={2}>
                    <Grid item lg={4}
                          ...
                          xl={6}
                          xs={12}>
                        <DashBoardCharts title={'TOTAL ' + "Talent"} color={'primary'}
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {filteredUsers
                                    ...
                                    .map((row) =>{
                                        let {id, name, email, skills, session,rollNo,department} = row;
                                        let regno=session+'-'+department+'-'+rollNo;
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <TableCell align="right">
                                                    <UserMoreMenu pageName={"Talent"} id={id}/>
                                                </TableCell>
                                            </TableRow>
                                        );
                                        }
            ...
            <AddNew open={open} handleClose={handleClose} pageName={"Talent"}/>
        </Page>
    );
}
